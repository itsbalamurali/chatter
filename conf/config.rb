...
Vines::Config.configure do
  ...
  # command. Change the example, 'flud.in', domain name to your actual
  # domain.
  #
  ...
  # available at games.flud.in and scores.flud.in as well as
  # games.verona.lit and scores.verona.lit.
  #
  # Shared storage example:
  # host 'verona.lit', 'flud.in' do
